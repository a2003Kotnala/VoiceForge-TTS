...
exports.applySpeechStyle = applySpeechStyle;
...
function applySpeechStyle(input) {
    ...
    return {
        ...
        expressiveness: clamp((input.expressiveness ?? 0.5) * 0.65 + preset.expressiveness * 0.35, 0, 1)
    };
}
